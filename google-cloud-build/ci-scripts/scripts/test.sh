...
then
  ...
  ./exaslct run-db-test --flavor-path "flavors/$FLAVOR"  --workers 7 --test-folder test/linker_namespace_sanity --release-goal base_test_build_run || echo "fail" > /workspace/build-status.txt
echo
echo "=========================================================="
