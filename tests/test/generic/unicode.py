        ...
        if udf.pythonVersionInUdf == 2:
            rows = self.query('''
                ...
                WHERE codepoint not between 55296 and 57343
                    ...
                    and not code between 4304 and 4346 -- Georgian Script Casing changed in Python 3.7 and Unicode 11 https://www.unicode.org/versions/Unicode11.0.0/#Migration, https://docs.python.org/3.7/whatsnew/3.7.html#unicodedata 
