create or replace python scalar script expal_test_pass_fail(res varchar(100)) emits (x int) as
def run(ctx):
    result = ctx.res
    if result == "ok":
        ctx.emit(1)
...
create or replace python scalar script expal_use_param_foo_bar(...) returns int as
...
create or replace python scalar script expal_use_connection_name(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
...
create or replace python scalar script expal_use_connection_info(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
...
create or replace python scalar script expal_use_has_truncate(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
...
create or replace python scalar script expal_use_replace_created_by(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
...
create or replace python scalar script expal_use_column_name_lower_case(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
...
create or replace python scalar script expal_use_column_selection(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
...
create or replace python scalar script expal_use_query(...) returns int as
def generate_sql_for_export_spec(export_spec):
    if (export_spec.parameters['FOO'] == 'bar' and
        export_spec.parameters['BAR'] == 'foo' and
        export_spec.connection_name is None and
