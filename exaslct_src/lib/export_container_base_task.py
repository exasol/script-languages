...
class ExportContainerBaseTask(StoppableTask):
    ...
    def output(self):
        return {EXPORT_INFO: self._target}

    def requires_tasks(self):
        return {"release_task": self.get_release_task(),
    ...
    def write_release_info(self, image_info_of_release_image: ImageInfo, is_new: bool,
        ...
        with self.output()[EXPORT_INFO].open("w") as file:
            file.write(json)
