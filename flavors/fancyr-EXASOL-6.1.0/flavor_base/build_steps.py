...
class AnalyzeFlavorBaseDeps1(DockerFlavorAnalyzeImageTask):
...
class AnalyzeFlavorBaseDeps2(DockerFlavorAnalyzeImageTask):

    def get_build_step(self) -> str:
        return "flavor_base_deps_2"

    def requires_tasks(self):
        return {"flavor_base_deps": AnalyzeFlavorBaseDeps1(flavor_path=self.flavor_path)}
...
class AnalyzeFlavorCustomization(DockerFlavorAnalyzeImageTask):
    ...
    def requires_tasks(self):
        return {"flavor_base_deps": AnalyzeFlavorBaseDeps2(flavor_path=self.flavor_path)}
