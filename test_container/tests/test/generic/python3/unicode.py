...
class _Python3UdfSetup(udf.TestCase):
    def setUp(self):
        ...
        self.query(udf.fixindent('''
            CREATE PYTHON3 SCALAR SCRIPT unicode_count(word VARCHAR(1000), convert_ INT)
        ...
        self.query(udf.fixindent('''
            CREATE PYTHON3 SCALAR SCRIPT unicode_len(word VARCHAR(1000))
            RETURNS INT AS
            def run(ctx):
        ...
        self.query(udf.fixindent('''
            CREATE PYTHON3 SCALAR SCRIPT unicode_upper(word VARCHAR(1000))
...
class Unicode(_Python3UdfSetup):
...
class UnicodeData(_Python3UdfSetup):
