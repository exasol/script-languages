...
echo "Copying common source fies to the build dir"
for SRC in \
        zmqcontainer.proto exascript.i filter_swig_code.py build_integrated.py zmqcontainerclient.cc \
...
if [ "$ENABLE_JAVA_IMPL" = "yes" ]; then
    ...
    CONTAINER_CLIENT_OBJECT_FILES="exascript_java.o javacontainer.o scriptoptionlines.o $CONTAINER_CLIENT_OBJECT_FILES"
...
g++ -o zmqcontainerclient zmqcontainerclient.o $CONTAINER_CLIENT_OBJECT_FILES zmqcontainer.pb.o scriptDTOWrapper.o scriptDTO.o $LDFLAGS $LIBS  || die "Failed to compile zmqcontainerclient"
