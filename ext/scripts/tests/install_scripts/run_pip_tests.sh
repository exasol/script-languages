...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'humanfriendly' 'requests' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install --ignore-installed --break-system-packages --no-cache-dir 'humanfriendly' 'requests' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install --use-deprecated=legacy-resolver --break-system-packages --no-cache-dir 'humanfriendly' 'requests' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'humanfriendly==9.1' 'requests==2.21.0'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'humanfriendly==9.1' 'requests' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'humanfriendly==9.1' 'requests==2.27.1' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'humanfriendly==9.1' 'requests>=2.21.0' 'git+http://github.com/exasol/bucketfs-utils-python.git@0.2.0#egg=exasol-bucketfs-utils-python'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-common==1.1.4' 'azure-common==1.1.28'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-common==1.1.4' 'azure-batch==1.0.0'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-common==1.1.28' 'azure-batch==1.0.0'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-storage-queue==1.1.0' 'azure-batch==1.0.0'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-batch==1.0.0' 'azure-storage-queue==1.1.0'"
echo
...
assert "$TEST_OUTPUT" "Dry-Run: python3 -m pip install  --break-system-packages --no-cache-dir 'azure-common==1.1.28' 'azure-batch==14.2.0' 'azure-storage-queue==1.1.0'"
echo
